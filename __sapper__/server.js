...
import * as __route_blog_json from "../src/routes/blog/index.json.js";
import * as __route_blog_$slug_json from "../src/routes/blog/[slug].json.js";
import __index from "../src/routes/index.html";
import __about from "../src/routes/about.html";
import __blog from "../src/routes/blog/index.html";
import __blog_$slug from "../src/routes/blog/[slug].html";
...
export const manifest = {
	server_routes: [
...

		{
			// blog/[slug].json.js
			pattern: /^\/blog\/([^\/]+?).json$/,
			handlers: __route_blog_$slug_json,
	...
	pages: [
...

		{
			...
			pattern: /^\/about\/?$/,
			parts: [
				{ name: "about", file: "about.html", component: __about }
			]
		},

		{
			...
			parts: [
				null,
				{ name: "blog", file: "blog/index.html", component: __blog }
			]
		},

		{
			...
			parts: [
				null,
				{ name: "blog_$slug", file: "blog/[slug].html", component: __blog_$slug, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
